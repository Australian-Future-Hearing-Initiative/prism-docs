...
For most users and researchers, we recommend using the **Unified Setup via Docker**. It is the most reliable way to run the PRISM Research Portal (both frontend and backend) without manually configuring installation options.
